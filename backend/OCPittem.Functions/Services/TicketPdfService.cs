            ...
            foreach (var ticket in tickets)
            {
                ...
                container.Page(page =>
                {
                    ...
                    page.Content().PaddingVertical(20).Column(col =>
                    {
                        ...
                        col.Item().Text($"Type: {typeLabel}").FontSize(12).Bold();
                        col.Item().Text($"Ticket ID: {ticket.TicketId}").FontSize(10).FontColor(Colors.Grey.Medium);
                        ...
                        col.Item().PaddingTop(15).AlignCenter().Column(qrCol =>
                        {
                            ...
                            qrCol.Item().AlignCenter()
                                ...
                                .Padding(10)
                                .Text(ticket.QrPayload).FontSize(8);
                        });
                    });
