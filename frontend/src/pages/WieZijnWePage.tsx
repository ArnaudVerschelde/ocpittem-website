...
const board: BoardMember[] = [
    ...
    { name: 'Mathias Lefebvre', role: 'Secretaris', initials: 'ML', color: 'bg-primary-100 text-primary-700' },
    { name: 'Nynke Colpaert', role: 'Verantwoordelijke communicatie/sociale media', initials: 'NC', color: 'bg-primary-100 text-primary-700' },
    { name: 'Arnaud Verschelde', role: 'Penningmeester & verantwoordelijke IT', initials: 'AV', color: 'bg-primary-100 text-primary-700' },
    { name: 'Steven Truyaert', role: 'Bestuurslid', initials: 'ST', color: 'bg-primary-100 text-primary-700' },
];

const members: Member[] = [
    { name: 'Annelies Degheldere', description: 'mama van Mila' },
    { name: 'Annelies Rotsaert', description: 'mama van Noémie en Alizée' },
    { name: 'Arnaud Verschelde', description: 'papa van Henri en Alixe' },
    ...
    { name: 'Elise Dejaeger', description: 'mama van Iza en Wies' },
    { name: 'Ellen Dewitte', description: 'mama van Warre' },
    { name: 'Evelien Vandoorne', description: 'mama van Annabelle, Juliette en Céleste' },
    { name: 'Jeroen Lafaut', description: 'papa van Léonie en Lucas' },
    { name: 'Jolien De Neve', description: 'mama van Nya en Zyas' },
    { name: 'Kevin Vandekerckhove', description: 'papa van Fayth en Luan' },
    { name: 'Marijn Tuytens', description: 'papa van Renée' },
    { name: 'Mathias Lefebvre', description: 'papa van Noémie en Alizée' },
    { name: 'Melissa Naert', description: 'mama van Odette en Maurice' },
    { name: 'Nathalie Delaere', description: 'mama van Emma en Emile' },
    { name: 'Nele Desseyn', description: 'mama van Mats en Lisa' },
    { name: 'Nele Spriet', description: 'mama van Bas en Wies' },
    { name: 'Nynke Colpaert', description: 'mama van Anna, Helena en Marie' },
    { name: 'Pieter Van Coillie', description: 'papa van Warre en Mila' },
    { name: 'Ruben Tavernier', description: 'papa van Arno, Gust en Nand' },
    { name: 'Sharon Verhenne', description: 'mama van Axel, Lexi en Roxy' },
    { name: 'Steve Deloof', description: 'papa van Juliette' },
    { name: 'Steven Truyaert', description: 'papa van Jasna en Otis' },
    { name: 'Tatjana Muylle', description: 'mama van Fayth en Luan' },
    { name: 'Thomas De Cuypere', description: 'papa van Matisse' },
];
