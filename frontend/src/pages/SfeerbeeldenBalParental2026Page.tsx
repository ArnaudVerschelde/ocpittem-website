...
export default function SfeerbeeldenBalParental2026Page() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      const shuffled = shuffle(res.images ?? []);
      setImages(shuffled);
  ...
  return (
    <>
      {/* Hero / Header — zelfde sfeer als de Bal Parental pagina */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:px-8 sm:py-24 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-6 text-4xl font-extrabold uppercase tracking-tight text-white sm:text-5xl lg:text-6xl">
              <span className="drop-shadow-[0_0_18px_rgba(255,255,255,0.22)]">Sfeerbeelden</span>{' '}
      ...
      <Section>
        ...
        {status === 'empty' && (
          <div className="mx-auto max-w-xl py-16 text-center">
            ...
            <p className="section-subtitle">
              Er zijn voorlopig nog geen foto's beschikbaar. Kom binnenkort zeker eens terug kijken!
            </p>
            <div className="mt-8">
        ...
        {status === 'error' && (
          <div className="mx-auto max-w-xl py-16 text-center">
            ...
            <p className="section-subtitle">
              De sfeerbeelden konden niet geladen worden. Probeer het straks opnieuw.
            </p>
            <div className="mt-8">
        ...
        {status === 'ready' && (
          <div className="space-y-12">
            ...
            <div>
              <h2 className="section-title text-center">Alle foto's</h2>
              <p className="section-subtitle mx-auto max-w-2xl text-center">
                Klik op een foto om ze groot te bekijken.
              </p>
              <div className="mt-8">
